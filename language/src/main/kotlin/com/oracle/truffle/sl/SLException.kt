 ...
 * implementation.
 */
open class SLException @TruffleBoundary
constructor(message: String, private val location: Node?) : RuntimeException(message), TruffleException {
    ...
    companion object {
        ...
        private val serialVersionUID = -6799734410727348507L
         ...
         */
        @TruffleBoundary
        fun typeError(operation: Node?, vararg values: Any?): SLException {
            ...
            if (operation != null) {
                ...
                if (ss != null && ss.isAvailable) {
                    result.append(" at ").append(ss.source.name).append(" line ").append(ss.startLine).append(" col ").append(ss.startColumn)
                }
            }

            result.append(": operation")
            if (operation != null) {
                val nodeInfo = SLContext.lookupNodeInfo(operation.javaClass)
                if (nodeInfo != null) {
            ...
            return SLException(result.toString(), operation!!)
        }
    }
