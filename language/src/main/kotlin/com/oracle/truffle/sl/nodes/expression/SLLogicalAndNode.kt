 ...
 */
@NodeInfo(shortName = "&&")
class SLLogicalAndNode(left: SLExpressionNode, right: SLExpressionNode) : SLShortCircuitNode(left, right) {
    ...
    /**
     * Only if left and right value are true the result of the logical and is `true`. If
     * the second parameter is not evaluated, `false` is provided.
     */
