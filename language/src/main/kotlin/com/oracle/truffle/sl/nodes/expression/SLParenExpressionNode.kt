...
/**
 * A [SLExpressionNode] that represents a parenthesized expression; it simply returns the
...
class SLParenExpressionNode(@field:Child private var expression: SLExpressionNode) : SLExpressionNode() {
