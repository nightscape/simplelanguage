...
/**
 * Base class for all builtin functions. It contains the Truffle DSL annotation [NodeChild]
 * that defines the function arguments.<br></br>
 * The builtin functions are registered in [SLContext.installBuiltins]. Every builtin node
 ...
 */
@NodeChild(value = "arguments", type = Array<SLExpressionNode>::class)
@GenerateNodeFactory
abstract class SLBuiltinNode : SLExpressionNode() {

    val context: SLContext
        get() = rootNode.getLanguage<SLLanguage>(SLLanguage::class.java).contextReference.get()
