...
/**
 * This class is similar to the extensively documented [SLAddNode]. Divisions by 0 throw the
 * same [exception][ArithmeticException] as in Java, SL has no special handling for it to keep
 * the code simple.
 */
@NodeInfo(shortName = "/")
abstract class SLDivNode : SLBinaryNode() {
