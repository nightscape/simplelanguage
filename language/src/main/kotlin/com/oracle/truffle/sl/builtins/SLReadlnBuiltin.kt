...
/**
 * Builtin function that reads a String from the [standard input][SLContext.getInput].
 */
@NodeInfo(shortName = "readln")
abstract class SLReadlnBuiltin : SLBuiltinNode() {

    @Specialization
    fun readln(): String {
        var result: String? = doRead(context.input)
        if (result == null) {
            /*
