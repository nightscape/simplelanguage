 ...
 */
@NodeInfo(shortName = "*")
abstract class SLMulNode : SLBinaryNode() {
    ...
    @Specialization
    @TruffleBoundary
    protected fun mul(left: SLBigNumber, right: SLBigNumber): SLBigNumber {
        return SLBigNumber(left.value.multiply(right.value))
    }
