...
/**
 * The class containing all message resolution implementations of [SLNull].
 */
/**
 * The class containing all message resolution implementations of [SLNull].
 */
@MessageResolution(receiverType = SLNull::class)
class SLNullMessageResolution {
    /*
     * An SL function resolves the IS_NULL message.
     */
    @Resolve(message = "IS_NULL")
    abstract class SLForeignIsNullNode : Node() {
    ...
    @CanResolve
    abstract class CheckNull : Node() {
        companion object {

            protected fun test(receiver: TruffleObject): Boolean {
                return receiver is SLNull
            }
        }
    }
}
