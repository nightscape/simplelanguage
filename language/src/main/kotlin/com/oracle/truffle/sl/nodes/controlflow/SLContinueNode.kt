 ...
 * frames that are between this [SLContinueNode] and the [SLWhileNode] of the loop we
 * are continuing. This is done by throwing an [exception][SLContinueException] that is caught
 * by the [loop node][SLWhileNode.executeVoid].
 */
@NodeInfo(shortName = "continue", description = "The node implementing a continue statement")
class SLContinueNode : SLStatementNode() {
