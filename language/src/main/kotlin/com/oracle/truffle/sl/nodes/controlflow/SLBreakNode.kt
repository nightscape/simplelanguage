 ...
 * frames that are between this [SLBreakNode] and the [SLWhileNode] of the loop we are
 * breaking out. This is done by throwing an [exception][SLBreakException] that is caught by
 * the [loop node][SLWhileNode.executeVoid].
 */
@NodeInfo(shortName = "break", description = "The node implementing a break statement")
class SLBreakNode : SLStatementNode() {
