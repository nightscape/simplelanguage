 ...
 */
@NodeInfo(shortName = "-")
abstract class SLSubNode : SLBinaryNode() {
    ...
    @Specialization
    @TruffleBoundary
    protected fun sub(left: SLBigNumber, right: SLBigNumber): SLBigNumber {
        return SLBigNumber(left.value.subtract(right.value))
    }
